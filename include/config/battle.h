...
#define B_FLAG_NO_WHITEOUT          FLAG_BATTLE_NO_WHITEOUT     // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
...
#define B_VAR_NO_BAG_USE         VAR_BATTLE_NO_BAG_USE     // If set to 1, the ability to use the Bag is disabled in Trainer battles. If set to 2, it is also disabled in wild battles.
...
#define B_OVERWORLD_FOG                 GEN_3 // In Gen8+, overworld Fog summons Misty Terrain in battle. In Gen4 only, overworld Fog summons the unique fog weather condition in battle. Set to GEN_3 to make fog purely visual; use FLAG_BATTLE_FOG for per-battle Gen 4 fog.
