...
#define VAR_STONES_TAKEN                                 0x40F7 // Unused Var
#define VAR_RUSTBORO_BROCK_CHALLENGE_STATE               0x40F8
#define VAR_BATTLE_NO_BAG_USE                            0x40F9
#define VAR_RUSTBORO_BROCK_ATTEMPT_COMPLETE              0x40FA
