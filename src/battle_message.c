...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNCUTSSPATKWITH]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s Sp. Atk fell!"),
    ...
    [STRINGID_RISING_TIDE_END]                      = COMPOUND_STRING("The sound of waves faded away!"),
...
const u16 gTerrainStringIds[B_MSG_TERRAIN_COUNT] =
{
    ...
    [B_MSG_TERRAIN_END_RISING_TIDE] = STRINGID_RISING_TIDE_END,
};
...
const u16 gMagmaCoreStringIds[] =
{
    [B_MSG_MAGMA_CORE_BOOST] = STRINGID_PKMNRAISEDFIREPOWERWITH,
};
