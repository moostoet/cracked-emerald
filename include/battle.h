...
{
    u16 changedStatsBattlerId:3; // Battler that was responsible for the latest stat change. Can be self.
    u16 neutralizingGasRemoved:1;
    u16 berryReduced:1;
    u16 mindBlownRecoil:1;
    u16 switchInAbilityDone:1;
    u16 updateStallMons:1;
    u16 statLowered:1;
    u16 abilityRedirected:1;
    u16 restoredBattlerSprite:1;
    u16 faintedHasReplacement:1;
    u16 afterYou:1;
    u16 damagedByAttack:1;
    u16 dancerUsedMove:1;
    u16 criticalHit:1;
    // End of 16-bit bitfield
    u8 gemParam:7;
    u8 gemBoost:1;
