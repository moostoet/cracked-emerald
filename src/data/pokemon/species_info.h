...
const struct SpeciesInfo gSpeciesInfo[] =
    ...
    #include "species_info/gen_9_families.h"
        ...
        [SPECIES_SPINDA_DRUNKEN] = {
            ...
            .abilities = {ABILITY_CONTRARY, ABILITY_SCRAPPY, ABILITY_JUMBLED}, // TODO add Jumbled
            .bodyColor = BODY_COLOR_BROWN,
            .noFlip = TRUE,
            .speciesName = _("Spinda"),
            .cryId = CRY_SPINDA,
            .natDexNum = NATIONAL_DEX_SPINDA,
            .categoryName = _("Drunken"),
            .height = 13,
            .weight = 62,
            .description = COMPOUND_STRING("Its unique pattern shifts as it sways\n"
                                           "in combat. Its wobbly movements are\n"
                                           "actually an ancient martial art that\n"
                                           "confounds and devastates opponents."),
            .pokemonScale = 321,
            .pokemonOffset = 4,
            .trainerScale = 256,
            .trainerOffset = 0,
            ...
            .palette = gMonPalette_SpindaDrunken,
