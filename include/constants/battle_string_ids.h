...
// gMagmaCoreStringIds
enum MagmaCoreStringID
{
    B_MSG_MAGMA_CORE_BOOST,
};
...
// Backward-compat alias used by custom code.
#define B_MSG_SET_RISING_TIDE B_MSG_TERRAIN_SET_RISING_TIDE

// gStartingStatusStringIds
enum StartingStatusStringID
{
    B_MSG_SET_TRICK_ROOM = (B_MSG_TERRAIN_SET_RISING_TIDE + 1),
